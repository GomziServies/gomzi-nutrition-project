...
function GomziNutritionPerformancePreWorkoutDrink() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("220ml-green apple");
  const [activeImageIndex, setActiveImageIndex] = useState(0);
  const [activeSize, setActiveSize] = useState("220ml");
  const [activeFlavor, setActiveFlavor] = useState("Green Apple");
  ...
  const productImages = {
    "220ml-green apple": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-performance-pre-workout-drink-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-pre-workout-drink-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-pre-workout-drink-4.webp",
    ],
  };

  const products = [
    {
      key: "220ml-green apple",
      data: {
        id: "674b01bf27420607a74da208",
        img: "/assets/images/nutrition/gomzi-nutrition-performance-pre-workout-drink-1.webp",
        name: "Performance Pre-Workout Drink",
        price: "81",
        discount: "81",
        size: "220ml",
        dis_point: "15%",
  ...
  const sizeOptions = [{ id: "220ml", label: "220ml" }];

  const flavorOptions = [{ id: "Green Apple", label: "Green Apple" }];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition Ignite Fat Burner Drink - Boost Metabolism & Burn Fat Fast"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                ...
                <div className="col-12 p-0 col-lg-7 h-100 mb-lg-0 px-0 px-md-3 product-detail-left">
                  ...
                  <div className="d-flex mt-4">
                    ...
                    <div className="col-6 p-0">
                      <p className="nutrition-content-1 text-bold">180 mg</p>
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Nutrition Performance Pre-Workout Drink
                            </strong>
                          </p>
                          <p className="mb-3">
                            At Gomzi LifeScience, we are committed to providing
                            athletes, fitness enthusiasts, and active
                            individuals with performance-enhancing beverages
                            that help maximize results. Our range of performance
                            drinks is scientifically formulated to fuel your
                            workouts, support recovery, and improve endurance,
                            energy, and strength. With high-quality ingredients
                            like creatine, EAA, caffeine, and L-citrulline, our
                            drinks are designed to optimize your physical
                            performance. Whether you're lifting, running, or
                            training for your next competition, Gomzi
                            LifeScience Performance Drinks are your trusted
                            companion to achieving your fitness goals.
                          </p>
                          <p className="mb-3">
                            Gomzi LifeScience Performance Pre-Workout Drink is a
                            powerful pre-workout formula designed to enhance
                            your energy, focus, and endurance. With 180 mg of
                            caffeine and 4.5 grams of L-citrulline per serving,
                            this drink prepares your body for intense physical
                            exertion by boosting blood flow, improving nitric
                            oxide production, and increasing energy levels.
                            L-citrulline is known to enhance endurance and
                            reduce muscle fatigue, while caffeine provides the
                            energy and focus needed to perform at your peak.
                          </p>
                          <p>
                            <strong>Benefits:</strong>
                          </p>
                          <p className="mb-2">
                            <b>Increased Energy & Focus:</b> The 180 mg of
                            caffeine provides a potent energy boost, keeping you
                            focused and alert throughout your workout.
                          </p>
                          <p className="mb-2">
                            <b>Enhanced Blood Flow:</b> L-citrulline boosts
                            nitric oxide levels, promoting better circulation
                            and more efficient nutrient delivery to muscles.
                          </p>
                          <p className="mb-2">
                            <b>Improved Endurance & Performance:</b>{" "}
                            L-citrulline helps delay fatigue, allowing you to
                            train harder and longer.
                          </p>
                          <p className="mb-3">
                            <b>Faster Muscle Recovery:</b> The enhanced blood
                            flow also supports quicker recovery by delivering
                            more oxygen and nutrients to muscles during
                            exercise.
                          </p>
                        </div>
                      </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b01bf27420607a74da208" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionPerformancePreWorkoutDrink;
