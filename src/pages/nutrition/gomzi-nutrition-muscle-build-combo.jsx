  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Boost muscle growth with Gomzi Nutrition Muscle Build Combo. A powerful blend of whey protein, creatine, and amino acids designed for serious muscle gains and recovery."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition Muscle Build Combo - Ultimate Stack for Muscle Growth"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-muscle-build-combo"
        />
