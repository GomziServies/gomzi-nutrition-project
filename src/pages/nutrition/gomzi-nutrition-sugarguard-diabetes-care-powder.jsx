...
function GomziNutritionSugarguardDiabetesCarePowder() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Gomzi Nutrition Sugarguard - Diabetes Care Powder for Healthy Blood
          Sugar
        </title>
        <meta
          name="description"
          content="Support healthy blood sugar levels with Gomzi Nutrition Sugarguard Diabetes Care Powder. A herbal blend designed to aid diabetes management and overall wellness."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition Sugarguard - Diabetes Care Powder for Healthy Blood Sugar"
        />
        <meta
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-2">
                            Take a spoon of Sugarguard Diabetes Care Powder(5gm)
                          </p>
                          <p className="mb-3">
