...
function GomziNutritionMangoChiaSeedCrunchyPeanutButter() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("500g-mango");
  const [activeImageIndex, setActiveImageIndex] = useState(0);
  const [activeSize, setActiveSize] = useState("500g");
  const [activeFlavor, setActiveFlavor] = useState("Mango");
  ...
  const productImages = {
    "500g-mango": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-mango-chia-seed-crunchy-peanut-butter-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-mango-chia-seed-crunchy-peanut-butter-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-mango-chia-seed-crunchy-peanut-butter-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "500g-mango",
      data: {
        id: "674b024627420607a74da22a",
        img: "/assets/images/nutrition/gomzi-nutrition-mango-chia-seed-crunchy-peanut-butter-1.webp",
        name: "Mango Chia Seed Crunchy Peanut Butter",
        price: "309",
        discount: "309",
        size: "500g",
        dis_point: "15%",
  ...
  const sizeOptions = [{ id: "500g", label: "500g" }];

  const flavorOptions = [{ id: "Mango", label: "Mango" }];
  ...
  return (
    <>
      <Helmet>
        <title>
          Mango Chia Peanut Butter - High Protein and Crunchy Spread | Gomzi
          Nutrition
        </title>
        <meta
          name="description"
          content="Enjoy the delicious and healthy Ketones Nutrition Mango Chia Peanut Butter. 20g protein, gluten-free, and perfect for snacking or adding to smoothies."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Mango Chia Peanut Butter - High Protein and Crunchy Spread | Gomzi Nutrition"
        />
        <meta
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Gomzi Lifescience Mass Gainer Powder. "
        }
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Lifescience Mango Chia Seed Crunchy Peanut
                              Butter
                            </strong>
                          </p>
                          <p className="mb-3">
                            At Gomzi LifeScience, we believe in delivering
                            premium, nutritious, and delicious peanut butter to
                            elevate your wellness journey. Our carefully crafted
                            peanut butter varieties are made from high-quality,
                            all-natural ingredients, packed with proteins,
                            healthy fats, and essential nutrients to fuel your
                            day. Whether you're looking for a crunchy snack, a
                            protein boost, or a delightful twist on flavor,
                            Gomzi LifeScience offers the perfect peanut butter
                            for every taste preference.
                          </p>
                          <p className="mb-3">
                            Our Mango Chia Seed Crunchy Peanut Butter combines
                            the creamy richness of peanuts with the tropical
                            sweetness of mango and the health benefits of chia
                            seeds. This exciting variant is packed with fiber,
                            omega-3 fatty acids, and antioxidants, offering a
                            unique fusion of flavors and nutrition. It's an
                            excellent way to enjoy a crunchy, flavorful snack
                          ...
                          <p className="mb-2">
                            <b>Tropical Flavor Fusion:</b> The sweet taste of
                            mango combined with the crunchiness of chia seeds
                            adds a tropical twist to your peanut butter
                            experience.
                          </p>
                          <p className="mb-2">
                            <b>Good Protein Source:</b> 20g of protein per 100g
                            to support muscle recovery and growth. Packed with
                            Omega-3s: Chia seeds are an excellent source of
                            plant-based omega-3 fatty acids, promoting brain
                            health and reducing inflammation.
                          </p>
                          <p className="mb-2">
                            <b>Packed with Omega-3s:</b> Chia seeds are an
                            excellent source of plant-based omega-3 fatty acids,
                            promoting brain health and reducing inflammation.
                          </p>
                          <p className="mb-3">
                            <b>High in Fiber:</b> Chia seeds contribute to
                            digestive health and keep you feeling full longer.
                          </p>
                          <p>
                            <strong>Directions of Use:</strong>
                          </p>
                          <p className="mb-2">
                            Spread on toast, bagels, or English muffins for a
                            nutritious breakfast.
                          </p>
                          <p className="mb-2">
                            Use as a dip for fruits or crackers for a healthy
                            snack.
                          </p>
                          <p className="mb-2">
                            Blend into smoothies or yogurt for added texture and
                            flavor.
                          </p>
                          <p className="mb-3">
                            Enjoy as a stand-alone snack straight from the jar.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b024627420607a74da22a" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionMangoChiaSeedCrunchyPeanutButter;
