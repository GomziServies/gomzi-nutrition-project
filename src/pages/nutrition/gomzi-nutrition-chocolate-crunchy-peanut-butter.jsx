...
function GomziNutritionChocolateCrunchyPeanutButter() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("500g-chocolate");
  ...
  const productImages = {
    "500g-chocolate": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-chocolate-crunchy-peanut-butter-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-chocolate-crunchy-peanut-butter-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-chocolate-crunchy-peanut-butter-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "500g-chocolate",
      data: {
        id: "674b028e27420607a74da22e",
        img: "/assets/images/nutrition/gomzi-nutrition-chocolate-crunchy-peanut-butter-1.webp",
  ...
  return (
    <>
      <Helmet>
        <title>
          Buy Gomzi Lifescience Chocolate Peanut Butter Crunchy Online at Best
          Price
        </title>
        <meta
          name="description"
          content="Shop for chocolate peanut butter crunchy online in best price at Gomzi Nutrition. Gomzi Nutrition chocolate peanut butter is a combination of American recipe with a desi twist with crunchy variation."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Buy Gomzi Nutrition Chocolate Peanut Butter Crunchy Online at Best Price"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-3">
                            Indulge in the rich, velvety flavor of our Chocolate
                            Crunchy Peanut Butter. A perfect blend of roasted
                            peanuts and premium cocoa, this variant offers a
                            delightful twist to your regular peanut butter.
                            While it's slightly sweeter than our Natural
                            version, it still provides a healthy dose of protein
                            and essential nutrients, making it a tasty yet
                            nutritious treat.
                          </p>
                          <p>
                          ...
                          <p className="mb-2">
                            <b>Delicious Chocolate Flavor:</b> A perfect balance
                            of chocolate and peanut butter, satisfying your
                            sweet cravings without guilt.
                          </p>
                          <p className="mb-2">
                            <b>Good Source of Protein:</b> 19g of protein per
                            100g to support muscle health and recovery. No
                            Artificial Additives: Made with only natural
                            ingredients, free from preservatives.
                          </p>
                          <p className="mb-3">
                            <b>Rich in Antioxidants:</b> Cocoa is a natural
                          ...
                          <p className="mb-2">
                            Perfect for spreading on bread, pancakes, or
                            waffles.
                          </p>
                          <p className="mb-2">
                            Add to smoothies or protein shakes for a chocolatey
                            twist.
                          </p>
                          <p className="mb-2">
                            Use as a dip for fruits like apple slices or
                            bananas.
                          </p>
                          <p className="mb-3">
                            Enjoy straight from the jar as a sweet, energizing
                            snack.
                          </p>
                        </div>
                      </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b028e27420607a74da22e" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionChocolateCrunchyPeanutButter;
