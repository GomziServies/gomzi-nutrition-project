...
function GomziNutritionWheyProteinIsolate() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Gomzi Nutrition Whey Protein Isolate - Premium Protein for Lean Muscle Mass
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-whey-protein-isolate"
        />
