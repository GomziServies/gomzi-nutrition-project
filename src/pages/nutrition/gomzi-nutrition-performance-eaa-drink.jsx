...
function GomziNutritionPerformanceEAADrink() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("220ml-guava");
  ...
  const productImages = {
    "220ml-guava": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-performance-eaa-drink-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-eaa-drink-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-eaa-drink-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "220ml-guava",
      data: {
        id: "674b01d027420607a74da20a",
        img: "/assets/images/nutrition/gomzi-nutrition-performance-eaa-drink-1.webp",
        name: "Performance EAA Drink",
        price: "81",
        discount: "81",
        size: "220ml",
        dis_point: "15%",
  ...
  const flavorOptions = [{ id: "Guava", label: "Guava" }];
  ...
  return (
    <>
      <Helmet>
        <title>
          Buy Gomzi Nutrition Spark EAA Drink - Essential Amino Acids for Muscle
          Recovery
        </title>
        <meta
          name="description"
          content="Fuel your muscles with Gomzi Nutrition Spark EAA with drink, a blend of essential amino acids for enhanced muscle recovery and endurance. Perfect for athletes and fitness enthusiasts."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Buy Gomzi Nutrition Spark EAA Drink - Essential Amino Acids for Muscle Recovery"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                ...
                <div className="col-12 p-0 col-lg-7 h-100 mb-lg-0 px-0 px-md-3 product-detail-left">
                  ...
                  <div className="d-flex mt-4">
                    ...
                    <div className="col-6 p-0">
                      <p className="nutrition-content-1 text-bold">45 Kcal</p>
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Nutrition Performance EAA Drink
                            </strong>
                          </p>
                          <p className="mb-3">
                          ...
                          <p className="mb-3">
                            Gomzi LifeScience Performance EAA Drink provides a
                            powerful blend of essential amino acids (EAAs) that
                            support muscle repair, reduce muscle soreness, and
                            improve exercise performance. With 45 kcal per
                            serving, this drink offers a low-calorie,
                            high-performance solution to support endurance and
                            recovery without unnecessary added sugars. Essential
                            amino acids play a critical role in protein
                            synthesis and can help prevent muscle breakdown
                          ...
                          <p className="mb-2">
                            <b>Boosts Muscle Recovery:</b> EAAs are critical for
                            muscle repair and reducing the catabolic effects of
                            intense exercise.
                          </p>
                          <p className="mb-2">
                            <b>Reduces Muscle Soreness:</b> Helps mitigate
                            delayed onset muscle soreness (DOMS), promoting
                            faster recovery between workouts.
                          </p>
                          <p className="mb-2">
                            <b>Supports Lean Muscle Growth:</b> By providing the
                            body with the essential building blocks needed for
                            muscle synthesis, EAAs help build and maintain
                            muscle tissue.
                          </p>
                          <p className="mb-3">
                            <b>Sustained Energy:</b> The low-calorie formula
                            provides clean, sustained energy during workouts,
                            without any crash or jitters.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b01d027420607a74da20a" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionPerformanceEAADrink;
