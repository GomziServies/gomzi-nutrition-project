...
function GomziNutritionAyureaseGastricReliefPowder() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Buy Gomzi Nutrition Ayurease - Natural Gastric Relief Powder
        </title>
        <meta
          name="description"
          content="Soothe indigestion and acidity with Gomzi Nutrition Ayurease. A herbal formula that provides natural gastric relief and improves digestive comfort."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Buy Gomzi Nutrition Ayurease - Natural Gastric Relief Powder"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-ayurease-gastric-relief-powder"
        />
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-2">
                            Take a spoon of Ayurease powder(5gm)
                          </p>
                          <p className="mb-3">
