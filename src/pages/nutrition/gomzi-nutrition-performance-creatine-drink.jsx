...
function GomziNutritionPerformanceCreatineDrink() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("220ml-cola");
  const [activeImageIndex, setActiveImageIndex] = useState(0);
  const [activeSize, setActiveSize] = useState("220ml");
  const [activeFlavor, setActiveFlavor] = useState("Cola");
  ...
  const productImages = {
    "220ml-cola": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-performance-creatine-drink-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-creatine-drink-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-performance-creatine-drink-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "220ml-cola",
      data: {
        id: "674b01f227420607a74da20c",
        img: "/assets/images/nutrition/gomzi-nutrition-performance-creatine-drink-1.webp",
        name: "Performance Creatine Drink",
        price: "81",
        discount: "81",
        size: "220ml",
        dis_point: "15%",
  ...
  const flavorOptions = [{ id: "Cola", label: "Cola" }];
  ...
  return (
    <>
      <Helmet>
        <title>
          Gomzi Nutrition ATP Creatine Drink - Enhance Strength & Muscle
          Performance
        </title>
        <meta
          name="description"
          content="Maximize your strength and muscle gains with Gomzi Nutrition ATP Creatine Drink. Proven to boost athletic performance, power, and muscle growth during workouts."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition ATP Creatine Drink - Enhance Strength & Muscle Performance"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Nutrition Performance Creatine Drink
                            </strong>
                          </p>
                          <p className="mb-3">
                          ...
                          <p className="mb-3">
                            Gomzi LifeScience Performance Creatine Drink is
                            designed to enhance your power, strength, and muscle
                            growth. Creatine is one of the most researched and
                            effective ingredients in sports nutrition, known for
                            its ability to increase strength, power output, and
                            endurance. Each serving of our Performance Creatine
                            Drink delivers 4.5 grams of pure creatine
                            monohydrate, a key compound that supports
                            high-intensity exercise performance, allowing you to
                            push harder and recover faster.
                          </p>
                          <p>
                            <strong>Benefits:</strong>
                          </p>
                          <p className="mb-2">
                            Enhanced Muscle Strength & Power: Creatine helps
                            replenish ATP (adenosine triphosphate) stores in
                            muscles, providing the energy needed for short
                            bursts of intense activity, such as weightlifting or
                            sprinting.
                          </p>
                          <p className="mb-2">
                            <b>Improved Endurance:</b> By increasing energy
                            availability, creatine allows you to perform more
                            reps or sustain higher-intensity efforts.
                          </p>
                          <p className="mb-2">
                            <b>Supports Muscle Growth:</b> Creatine promotes
                            water retention in muscle cells, which contributes
                            to muscle size and growth over time.
                          </p>
                          <p className="mb-3">
                            <b>Quick and Easy Absorption:</b> Our drink
                            formulation ensures rapid absorption of creatine to
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b01f227420607a74da20c" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionPerformanceCreatineDrink;
