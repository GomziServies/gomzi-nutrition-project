...
function GomziNutritionSportsJogger() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("l-black");
  ...
  const productImages = {
    "l-black": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-sports-jogger-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-sports-jogger-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-sports-jogger-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "l-black",
      data: {
        id: "674b019b27420607a74da204",
        img: "/assets/images/nutrition/gomzi-nutrition-sports-jogger-1.webp",
        name: "Gomzi Nutrition Sports Jogger",
        price: "499",
        discount: "499",
        size: "L",
        dis_point: "15%",
  ...
  const sizeOptions = [{ id: "L", label: "L" }];
  ...
  return (
    <>
      <Helmet>
        <title>Essential Jogger Charcoal Black | Gomzi Nutrition</title>
        <meta
          name="description"
          content="No gym bag is complete without The Essential Joggers. They provide functionality, so you're ready for training, commuting, or resting."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Essential Jogger Charcoal Black | Gomzi Nutrition"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>Gomzi Nutrition Sports Jogger</strong>
                          </p>
                          <p>
                            <strong>Performance-Oriented Design:</strong>
                          </p>
                          <p className="mb-3">
                            Elevate your training sessions with Gomzi Sports
                            Joggers, designed to deliver power, style, and
                            functionality. Featuring a supportive fit and a
                            customizable drawcord waist, these joggers ensure
                            maximum comfort and adaptability. With side pockets
                            and a secure zippered back pocket, you'll have ample
                            storage space for your essentials, seamlessly
                          ...
                          <p className="mb-3">
                            Engineered with breathable fabric, these joggers
                            enhance air circulation and moisture control,
                            keeping you cool, dry, and comfortable during
                            workouts or casual wear.
                          </p>
                          <p>
                            <strong>Advanced Quick-Dry Technology:</strong>
                          </p>
                          <p className="mb-3">
                            Gomzi Sports Joggers are crafted with innovative
                            quick-dry fabric that wicks sweat away from the body
                            and promotes rapid evaporation. Stay fresh and
                            confident during your most intense training
                            sessions.
                          </p>
                          <p>
                            <strong>
                              Unmatched Flexibility with Stretchable Fabric:
                            </strong>
                          </p>
                          <p className="mb-3">
                            Constructed from a durable poly-spandex blend, these
                            joggers provide exceptional stretchability for a
                            full range of motion. Whether you're stretching,
                            running, or engaging in high-impact activities,
                            enjoy unrestricted movement and comfort.
                          </p>
                          <p>
                            <strong>Microfiber Skin-Friendly Material:</strong>
                          </p>
                          <p className="mb-3">
                            Crafted from premium microfiber, Gomzi Sports
                            Joggers offer a soft, lightweight feel that's gentle
                            on the skin. Designed to minimize irritation or
                            chafing, they ensure lasting comfort for prolonged
                            wear.
                          </p>
                          <p>
                            <strong>Enhanced Durability & Style:</strong>
                          </p>
                          <p className="mb-3">
                            These joggers are built to withstand rigorous use
                            while maintaining their style and functionality.
                            Perfect for both active workouts and casual outings,
                            Gomzi Sports Joggers are a versatile addition to
                            your wardrobe.
                          </p>
                          <p>
                            <strong>Eco-Friendly Innovation:</strong>
                          </p>
                          <p className="mb-3">
                            Gomzi Sports Joggers are produced using sustainable
                            materials and methods, offering an eco-conscious
                            choice for athletes who value environmental
                            responsibility.
                          </p>
                        </div>
                      </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b019b27420607a74da204" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionSportsJogger;
