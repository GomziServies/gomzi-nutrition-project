...
function GomziNutritionActiveTShirt() {
  ...
  const productImages = {
    "l-black": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-sports-active-t-shirt-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-sports-active-t-shirt-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-sports-active-t-shirt-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "l-black",
      data: {
        id: "674b01ad27420607a74da206",
        img: "/assets/images/nutrition/gomzi-nutrition-sports-active-t-shirt-1.webp",
        name: "Gomzi Nutrition Sports Active T-shirt",
        price: "219",
        discount: "219",
        size: "L",
        dis_point: "15%",
  ...
  return (
    <>
      <Helmet>
        <title>
          Active Tee Half Sleeve Workout Black large | Gomzi Nutrition
        </title>
        <meta
          name="description"
          content="Get the best quality Tee half sleeve online? Look no further than high quality and affordable T-Shirts at Gomzi Nutrition."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Active Tee Half Sleeve Workout Black large | Gomzi Nutrition"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Nutrition Sports Active T-shirt
                            </strong>
                          </p>
                          <p>
                            <strong>Performance-Driven Design:</strong>
                          </p>
                          <p className="mb-3">
                            Gomzi Sports Active T-shirt is designed to inspire
                            peak performance in every athlete. Crafted for those
                            who strive to push limits, our T-shirt encourages
                            you to dream big, train hard, and achieve greatness.
                            Its sleek, modern look complements your active
                            lifestyle, both in and out of the gym.
                          </p>
                          <p>
                            <strong>Advanced Breathable Fabric:</strong>
                          </p>
                          <p className="mb-3">
                            Featuring premium-grade fabric that promotes optimal
                            airflow, this T-shirt ensures superior ventilation
                            and moisture control. Stay cool, dry, and
                            comfortable whether you're hitting the gym, running
                            a marathon, or enjoying a casual day out.
                          </p>
                          <p>
                            <strong>Rapid Dry Technology:</strong>
                          </p>
                          <p className="mb-3">
                            Our cutting-edge fabric wicks sweat away from your
                            skin and disperses it quickly to the surface,
                            enabling rapid evaporation. Stay fresh and dry
                            throughout your workout sessions with Gomzi's
                            quick-dry innovation.
                          </p>
                          <p>
                            <strong>
                              Maximum Stretchability for Unrestricted Movement:
                            </strong>
                          </p>
                          <p className="mb-3">
                            Made from a high-quality poly-spandex blend, the
                            Gomzi Active T-shirt provides unmatched stretch and
                            flexibility. Whether you're lifting weights,
                            practicing yoga, or performing high-intensity
                            drills, the T-shirt moves with you, offering
                            complete freedom of motion.
                          </p>
                          <p>
                            <strong>
                              Skin-Friendly Comfort with Microfiber Technology:
                            </strong>
                          </p>
                          <p className="mb-3">
                            Enjoy the soft, lightweight feel of microfiber
                            fabric that's gentle on the skin and prevents
                            irritation or chafing during prolonged wear. Durable
                            and long-lasting, it's ideal for athletes seeking
                            reliable, skin-friendly apparel.
                          </p>
                          <p>
                            <strong>Eco-Conscious Craftsmanship:</strong>
                          </p>
                          <p className="mb-3">
                            Gomzi Sports Active T-shirt incorporates sustainable
                            production techniques, making it an eco-friendly
                            choice for fitness enthusiasts who care about the
                            planet.
                          </p>
                        </div>
                      </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b01ad27420607a74da206" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionActiveTShirt;
