              ...
              <div className="row">
                ...
                <div className="col-12 text-center mb-4 px-4">
                  <div className="ql-editor text-left mt-3">
                    ...
                    <p className="mb-2  int-regular">
                      <strong>Immediate Action:</strong> If you decide to cancel
                      your order, please contact us as soon as possible. We
                      recommend reaching out within a few hours of placing your
                      order, as this increases the likelihood that we can
                      process your request before your order is shipped.
                    </p>
                    <p className="mb-2  int-regular">
                      <strong>Refund Process:</strong> If your order has not yet
                      been shipped, we will process your cancellation request
                      promptly. You will receive a full refund, which will be
                      issued to the original payment method. Please allow 5-7
                    ...
                    <p className="mb-2  int-regular">
                      <strong>Post-Shipment Policy:</strong> Once an order has
                      been shipped, we are unable to cancel it. In such cases,
                      you will need to follow our Return Policy to return the
                      item once it is delivered.
                    </p>
                    <p className="mb-3  int-regular">
                      <strong>Return Process:</strong> If you receive your order
                      and wish to return it, please review our Return Policy for
                    ...
                    <p className="mb-2  int-regular">
                      <strong>Contact Customer Service:</strong> Reach out to
                      our dedicated customer service team via:
                      <br />
                    ...
                    <p className="mb-2  int-regular">
                      <strong> Confirmation of Cancellation:</strong> Our
                      customer service representative will verify the status of
                      your order and confirm whether it can be canceled. We will
                      communicate the next steps to you as quickly as possible.
                    </p>
                    <p className="mb-3  int-regular">
                      <strong>Processing Your Refund:</strong> If your
                      cancellation is approved, we will initiate a full refund
                      to your original payment method. The processing time for
                      refunds typically ranges from 5-7 business days, depending
                    ...
                    <p className="mb-2  int-regular">
                      <strong>Recurring Orders:</strong> If you are subscribed
                      to a recurring order or service, you can cancel your
                      subscription at any time. To avoid being charged for the
                      next billing cycle, please ensure that you cancel at least
                      24 hours before the scheduled billing date.
                    </p>
                    <p className="mb-2  int-regular">
                      <strong>Subscription Cancellation Process:</strong> To
                      cancel your subscription, please contact our customer
                      service team for assistance. You will receive confirmation
                      once your subscription has been successfully canceled.
                    </p>
                    <p className="mb-2  int-500">
                      <b>(ii) Promotional Offers:</b>
                    </p>
                    <p className="mb-3  int-regular">
                      <strong>Special Promotions:</strong> Certain promotional
                      offers may have specific terms and conditions related to
                      cancellations. These terms will be clearly outlined at the
                      time of purchase. Please review these terms carefully to
                    ...
                    <p className="mb-2  int-regular">
                      <strong>Timeliness:</strong> We encourage you to act
                      quickly if you wish to cancel your order. Once an order is
                      in the shipping process, it may be too late to cancel, and
                      you will need to initiate a return.
                    </p>
                    <p className="mb-2  int-regular">
                      <strong>Contacting Us:</strong> Our customer service team
                      is here to assist you with any questions or concerns
                      regarding your order cancellation. We strive to respond to
