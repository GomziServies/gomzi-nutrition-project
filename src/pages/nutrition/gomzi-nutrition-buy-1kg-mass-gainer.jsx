...
function GomziNutritionBuy1MassGainer() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Muscle Matrix Mass Gainer with Free Creatine & Shaker | Pre-Gym Nutrition
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-buy-1kg-mass-gainer"
        />
