...
import NutritionHeader from "../../components/partials/Header/nutritionsheader.jsx";
import "@fortawesome/fontawesome-free/css/all.min.css";
import "../../assets/css/nutrition.css";
import NutritionFooter from "../../components/partials/Footer/nutritionfooter.jsx";
import LoginModal from "../../assets/js/popup/login.jsx";
import NutritionReviewSection from "../../components/partials/review/nutrition-review.jsx";
import CertifiedProduct from "../../components/nutrition/certified.jsx";
import ModalVideo from "react-modal-video";
import "react-lazy-load-image-component/src/effects/blur.css";
import { LazyLoadImage } from "react-lazy-load-image-component";
import MoreProducts from "../../components/nutrition/moreProducts.jsx";
import HappyClientReview from "../../components/nutrition/happyClient.jsx";
import WhatsappHeaderApp from "../../components/NutritionWhatsappHeaderBtn.jsx";
...
function GomziNutritionChocolateProteinBar() {
  ...
  const [currentProduct, setCurrentProduct] = useState("35g-Chocolate");
  const [activeImageIndex, setActiveImageIndex] = useState(0);
  const [activeSize, setActiveSize] = useState("35g");
  ...
  const productImages = {
    "35g-Chocolate": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-chocolate-protein-bar-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-chocolate-protein-bar-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-chocolate-protein-bar-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "35g-Chocolate",
      data: {
        id: "674b00f027420607a74da200",
        img: "/assets/images/nutrition/gomzi-nutrition-chocolate-protein-bar-1.webp",
  ...
  const sizeOptions = [{ id: "35g", label: "35g" }];
  ...
  return (
    <>
      <Helmet>
        <title>
          Chocolate Peanut Butter Protein Bar By Gomzi Nutrition
        </title>
        <meta
          name="description"
          content="Tired of choosing between health and taste? With Gomzi Nutrition Protein Bar, you get the best of both worlds! Designed for active, health-conscious individuals, this bar is more than just a snack—it's a powerhouse of nutrition, delivering 20g of quality protein paired with a rich chocolaty indulgence."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Chocolate Peanut Butter Protein Bar By Gomzi Nutrition"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-chocolate-protein-bar"
        />
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                ...
                <div className="col-12 p-0 col-lg-7 h-100 mb-lg-0 px-0 px-md-3 product-detail-left">
                  ...
                  <div className="d-flex mt-4">
                    <div className="col-12 p-0">
                      <p className="nutrition-content-1 text-bold">20g</p>
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p className="mb-3">
                            <strong>
                              Gomzi Nutrition Chocolate Protein Bar
                            </strong>
                          </p>
                          <p className="mb-4">
                            Our Chocolate Flavour Protein Bar is a delicious,
                            high-protein snack that blends the goodness of soy
                            protein isolate and whey protein isolate, providing
                            your muscles with the essential nutrients they need
                            for growth and recovery. Each bar contains 20g of
                            protein in a 35g serving, making it the perfect
                            snack for post-workout recovery, or anytime you need
                            a nutritious energy boost. The indulgent taste of
                            sugar-free Belgian chocolate, combined with honey,
                            hazelnuts, and Himalayan pink salt, makes this
                            protein bar a delightful treat that keeps you on
                            track with your fitness goals.
                          </p>
                          <p className="mb-2">
                            <strong>
                              Benefits of Chocolate Flavour Protein Bar:-
                            </strong>
                          </p>
                          <p>
                            <strong>High-Quality Protein Blend:</strong> This
                            protein bar features a powerful combination of soy
                            protein isolate and whey protein isolate, both of
                            which are excellent sources of essential amino acids
                            that support muscle recovery, growth, and repair.
                          </p>
                          <p>
                            <strong>20g of Protein per Serving:</strong> With
                            20g of protein packed into each 35g serving, this
                            protein bar is perfect for post-workout recovery or
                            as a filling snack to curb hunger between meals.
                          </p>
                          <p>
                            <strong>
                              Supports Muscle Growth and Recovery:
                            </strong>{" "}
                            The protein content in this bar helps in the
                            synthesis of muscle proteins, aiding in muscle
                            growth and recovery, especially after intense
                            workouts.
                          </p>
                          <p>
                            <strong>Low-Sugar and Sugar-Free Options:</strong>{" "}
                            The use of sugar-free Belgian chocolate and honey
                            ensures a sweet, satisfying taste without the excess
                            sugar, making it suitable for those on a low-sugar
                            or keto diet.
                          </p>
                          <p>
                            <strong>
                            ...
                            Infused with prebiotic fibre
                            (Fructooligosaccharide), this protein bar helps
                            support gut health, promoting healthy digestion and
                            a balanced microbiome.
                          </p>
                          <p>
                            <strong>Rich in Healthy Fats: </strong>High Oleic
                            Sunflower Oil and hazelnuts provide a source of
                            healthy fats, which are essential for heart health
                            and sustained energy throughout the day.
                          </p>
                          <p className="mb-4">
                            <strong>No Artificial Additives: </strong>We keep
                            things clean with minimal processing, ensuring your
                            protein bar is free from unnecessary artificial
                          ...
                          <p>
                            <strong>Protein 35%:</strong> A blend of Soy Protein
                            Isolate and Whey Protein Isolate for a high-quality
                            protein source.
                          </p>
                          <p>
                            <strong>Sugar-free Belgian Chocolate:</strong>{" "}
                            Provides a rich, indulgent taste without added
                            sugars.
                          </p>
                          <p>
                            <strong>Honey:</strong> A natural sweetener that
                            adds to the flavor profile.
                          </p>
                          <p>
                            <strong>
                              Prebiotic Fibre (Fructooligosaccharide):
                            </strong>{" "}
                            Supports digestive health by promoting beneficial
                            gut bacteria.
                          </p>
                          <p>
                            <strong>Humectant (INS 9650) & INS 422:</strong>{" "}
                            Helps maintain moisture and texture.
                          </p>
                          <p>
                            <strong>High Oleic Sunflower Oil:</strong> Provides
                            healthy fats and enhances the texture.
                          </p>
                          <p>
                            <strong>Hazelnuts:</strong> Adds a crunchy texture
                            and is a good source of healthy fats.
                          </p>
                          <p>
                            <strong>Cocoa Solids:</strong> Adds a deep, rich
                            chocolate flavor.
                          </p>
                          <p>
                            <strong>Himalayan Pink Salt:</strong> Enhances the
                            flavor and provides essential minerals.
                          </p>
                          <p>
                            <strong>Emulsifier (INS 322):</strong> Helps blend
                            ingredients smoothly.
                          </p>
                          <p className="mb-4">
                            <strong>Allergens:</strong>Soy, Nuts, Milk.
                          </p>

                          <p className="mb-2">
                            <strong>General Benefits of Protein Bars:-</strong>
                          </p>
                          <p>
                            <strong>Convenience:</strong> Protein bars are a
                            quick, portable snack that fits easily into a busy
                            lifestyle. They're ideal for pre or post-workout
                            fuel, or as a nutritious snack on the go.
                          </p>
                          <p>
                            <strong>Muscle Support:</strong> With a combination
                            of soy and whey proteins, protein bars help repair
                            and build muscle after intense physical activity,
                            ensuring optimal recovery and growth.
                          </p>
                          <p>
                            <strong>Balanced Nutrients:</strong> Protein bars
                            provide a good balance of protein, healthy fats, and
                            fiber, which helps control hunger, supports
                            digestion, and sustains energy throughout the day.
                          </p>
                          <p>
                            <strong>Satisfying & Tasty:</strong> Enjoy the rich
                            flavors of chocolate and hazelnuts while staying on
                            track with your health goals. Protein bars allow you
                            to indulge without guilt, offering a healthy
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b00f027420607a74da200" />
          </div>
          <CertifiedProduct />
          <MoreProducts />
        </section>
...
export default GomziNutritionChocolateProteinBar;
