...
import AddtoCartOffCanvas from "../../components/addtocartcanvas.jsx";
...
function GomziNutritionboweleaseConstipationReliefPowder() {
  ...
  const product = [
    ...
    "/assets/images/nutrition/bowelease-constipation-relief-powder-2.webp",
    "/assets/images/nutrition/bowelease-constipation-relief-powder-3.webp",
    "/assets/images/nutrition/bowelease-constipation-relief-powder-4.webp",
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Relieve constipation naturally with Gomzi Nutrition bowelease  Powder. A gentle, effective formula for digestive health, promoting regular bowel movements."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition bowelease  - Effective Constipation Relief Powder"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-bowelease-constipation-relief-powder"
        />
                  ...
                  <div className="row">
                          ...
                          <div className="avail-in-other-size-main">
                            <div className="d-block avail-in-other-size active">
                              <span className="d-block product-type avail-other-size cp active">
                                <p className="d-block m-0">250 gms</p>
                              </span>
                            </div>
                          </div>
                        </li>
                    ...
                    <div className="col-12">
                      <h1 className="f-rob-bol f-22 text-bold">
                        bowelease Constipation Relief Powder
                      </h1>
                    </div>
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-3">
                            Introducing "bowelease Constipation Relief Powder" -
                          ...
                          <p className="mb-2">
                            Take a spoon of bowelease Constipation Relief
                            Powder(5gm)
                          </p>
                          <p className="mb-3">
                            Drink half glass of warm water to swallow it
                          </p>
                          <p>
                            <strong>
                              bowelease Constipation Relief Powder's Health
                              Benefits:
                            </strong>
                          </p>
                          <p className="mb-2">
                            - <b>Gentle relief from constipation:</b> bowelease
                          ...
                          <p className="mb-3">
                            ...
                            constipation effectively, bowelease Constipation
                          ...
                          <p className="mb-3">
                            ...
                            bowelease Constipation Relief Powder, and rediscover
...
export default GomziNutritionboweleaseConstipationReliefPowder;
