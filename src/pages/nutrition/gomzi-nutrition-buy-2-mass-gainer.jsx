...
function GomziNutritionBuy2MassGainer() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Fuel workouts with our Mass Gainer and Creatine. Free Shaker included
        </title>
        <meta
          name="description"
          content="Boost your workout with Muscle Matrix Mass Gainer in Chocolate flavor, featuring Lemon-flavored Creatine. Enjoy a free shaker with every purchase."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Fuel workouts with our Mass Gainer and Creatine. Free Shaker included"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-buy-2-mass-gainer"
        />
