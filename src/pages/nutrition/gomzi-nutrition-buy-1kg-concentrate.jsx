...
function GomziNutritionBuy1KgConcentrate() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Premium Whey Concentrate 1kg with Free EAA and Shaker | Nutrition
        </title>
        <meta
          name="description"
          content="Boost your protein intake with our 1kg Whey Concentrate. Includes free EAA and shaker! Perfect for pre-gym supplements. Enhance nutrition and collagen."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Premium Whey Concentrate 1kg with Free EAA and Shaker | Nutrition"
        />
        <meta
