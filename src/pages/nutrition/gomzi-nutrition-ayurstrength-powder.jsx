  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Boost your strength and immunity with Gomzi Nutrition AyurStrength. A powerful herbal blend that enhances physical performance and supports overall health."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Gomzi Nutrition AyurStrength - Herbal Formula for Strength & Immunity"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.gomzilifesciences.in/nutrition/gomzi-nutrition-ayurstrength-powder"
        />
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-2">
                            Take a spoon of Ayurveda with Ayurstrength
                            powder(5gm)
                          </p>
                          <p className="mb-3">
