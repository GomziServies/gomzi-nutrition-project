...
function WhiteLabelling() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
           White Label Nutrition Products - Gomzi Nutrition Manufacture
        </title>
        <meta
          name="description"
          content="Partner with Gomzi Nutrition for top-quality white label nutrition products—custom formulations by a trusted Indian manufacturer."
        />
        <meta
          name="keyword"
                    ...
                    >
                      <div className="descriptionShow text-secondary whitelable-decription">
                        <p className="mb-3 mt-3">
                          ...
                          Gomzi Lifescience LLP. is an ISO 22000:2018 & WHO-GMP,
                          HACCP, HALAL, FSSAI Certified company Established and
                          Run by Dr. Gautam Jani In 2024. With the vision to
                          provide the best possible range of international
                          quality products at competitive prices through
                          integration, research and innovation. Gomzi
                          Lifescience LLP. is located in Surat in India Engaged
                          in supplying Nutraceutical finished products in
                          accordance to customized requirement of client in
                          India
                        </p>
                      </div>
                      <div className="descriptionShow text-secondary whitelable-decription">
            ...
            <div className="row vision-section">
              ...
              <div className="right-section">
                ...
                <p>
                  ...
                  distribution of superior-quality nutraceutical products. We
                  aim to enhance the health and well-being of individuals
                  worldwide through innovative solutions that combine scientific
                  research, cutting-edge technology, and sustainable practices.
                  By fostering a culture of integrity, excellence, and social
                  responsibility, we aspire to set new benchmarks in the
                  nutraceutical industry and contribute to a healthier, happier
                  world.
                </p>
              </div>
            </div>
            ...
            <div className="row mission-section align-items-start">
              <div className="right-section">
                ...
                <p>
                  ...
                  evolving needs of our customers while adhering to the highest
                  standards of quality, safety, and regulatory compliance. We
                  strive to:
                </p>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 return-policy-main">
                            <div className="mt-3 editor-text">
                              ...
                              <div className="pb-2 ql-editor descriptionShow text-secondary">
                                <Link
                                  to="https://api.whatsapp.com/send?phone=6354051487&amp;text= Hello, I have an inquiry about third-party manufacturing for the Performance Drinks product."
                                  type="button"
                                  className="btn-interested mx-2 mt-3"
                                >
                                  Yes, I am interested!
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 return-policy-main">
                            <div className="mt-3 editor-text">
                              ...
                              <div className="pb-2 ql-editor descriptionShow text-secondary">
                                <Link
                                  to="https://api.whatsapp.com/send?phone=6354051487&amp;text= Hello, I have an inquiry about third-party manufacturing for the Peanut Butter product."
                                  type="button"
                                  className="btn-interested mx-2 mt-3"
                                >
                                  Yes, I am interested!
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 return-policy-main">
                            <div className="mt-3 editor-text">
                              ...
                              <div className="pb-2 ql-editor descriptionShow text-secondary">
                                <Link
                                  to="https://api.whatsapp.com/send?phone=6354051487&amp;text= Hello, I have an inquiry about third-party manufacturing for the Energy Drink."
                                  type="button"
                                  className="btn-interested mx-2 mt-3"
                                >
                                  Yes, I am interested!
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 return-policy-main">
                            <div className="mt-3 editor-text">
                              ...
                              <div className="pb-2 ql-editor descriptionShow text-secondary">
                                <Link
                                  to="https://api.whatsapp.com/send?phone=6354051487&amp;text= Hello, I have an inquiry about third-party manufacturing for the Protein Bar."
                                  type="button"
                                  className="btn-interested mx-2 mt-3"
                                >
                                  Yes, I am interested!
