  ...
  return (
        ...
        <div className="container-fluid w-80 mt-5">
          ...
          <div className="vision-mission-container mt-0 pt-0">
            <div className="row mission-section align-items-start">
              <div
                className="left-section d-none d-md-block"
                ...
                <Link to="#" className="text-decoration-none d-block mb-3">
                  ...
                  >
                    <p
                      ...
                      style={{ color: "#333" }}
                    >
                      Protein Powders (Whey, Plant-Based, Mass Gainers)
                    </p>
                  </div>
                </Link>
	...
	•	PAN India Manufacturing Support
                    ...
                    <li className="d-flex align-items-start mb-2">
                      <div>
                        <p className="mission-desc">
                          ...
                          <>top 10 nutrition company in India</> standards,
                          Gomzi Lifescience offers comprehensive support for
                ...
                <div className="descriptionShow text-secondary whitelable-decription">
                  ...
                  <p className="mt-3">
                    <strong>
                      ...
                      powders, tablets, capsules and more."
                    </strong>
                  </p>
            ...
            <div className="row mission-section align-items-start">
              <div className="left-section mb-2">
                <img
                  ...
                  alt="Gomzi Lifesciences Mission"
                  className=" "
                  style={{ top: "0px" }}
                />
              </div>
            ...
            <div className="row mission-section align-items-start">
              <div className=" d-block d-md-none mb-2">
                <img
                  src="/assets/images/nutrition/Flexible-img.webp"
                  alt="Gomzi Lifescience Support Every Brand"
                  className="illustration-image"
                />
              </div>
              <div className="left-section">
                ...
                >
                  ...
                  <p className="mt-0 mb-0">
                    ...
                    <p className="mt-3">
                      {" "}
                      By maintaining integrity, transparency, and
                      customer-centricity, we work to become a{" "}
                      <strong>
