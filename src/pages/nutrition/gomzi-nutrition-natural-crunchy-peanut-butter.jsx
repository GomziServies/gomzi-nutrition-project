...
function GomziNutritionNaturalCrunchyPeanutButter() {
  const [menuOpen, setMenuOpen] = useState(false);
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoUrl, setVideoUrl] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [productData, setProductData] = useState(null);
  const [currentProduct, setCurrentProduct] = useState("500g-natural");
  const [activeImageIndex, setActiveImageIndex] = useState(0);
  const [activeSize, setActiveSize] = useState("500g");
  const [activeFlavor, setActiveFlavor] = useState("Natural");
  ...
  const productImages = {
    "500g-natural": [
      ...
      "/assets/images/nutrition/gomzi-nutrition-natural-crunchy-peanut-butter-2.webp",
      "/assets/images/nutrition/gomzi-nutrition-natural-crunchy-peanut-butter-3.webp",
      "/assets/images/nutrition/gomzi-nutrition-natural-crunchy-peanut-butter-4.webp",
    ],
  };
  ...
  const products = [
    {
      key: "500g-natural",
      data: {
        id: "674b028027420607a74da22c",
        img: "/assets/images/nutrition/gomzi-nutrition-natural-crunchy-peanut-butter-1.webp",
  ...
  const flavorOptions = [{ id: "Natural", label: "Natural" }];
  ...
  return (
    <>
      <Helmet>
        <title>Natural Crunchy Peanut Butter | Gomzi Lifescience</title>
        <meta
          name="description"
          content="Made with just one ingredient, our Natural Peanut Butter is as natural as it can get. The best addition to your diet to increase the protein intake. All Gomzi Nutrition Products are made up of the finest grade, fresh and nutritious ingredients from FSSAI approved Factory. We manufacture India."
        />
        <meta
          name="keyword"
        ...
        <meta
          property="og:title"
          content="Natural Crunchy Peanut Butter | Gomzi Nutrition"
        />
        <meta
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                ...
                <div className="col-12 p-0 col-lg-7 h-100 mb-lg-0 px-0 px-md-3 product-detail-left">
                  ...
                  <div className="d-flex mt-4">
                    ...
                    <div className="col-4 p-0">
                      <p className="nutrition-content-1 text-bold">28g</p>
                    ...
                    >
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          <p>
                            <strong>
                              Gomzi Lifescience Natural Crunchy Peanut Butter
                            </strong>
                          </p>
                          <p className="mb-3">
                          ...
                          <p className="mb-3">
                            Our Natural Crunchy Peanut Butter is made from the
                            finest roasted peanuts, blended to perfection with a
                            satisfying crunch. It contains no added sugars or
                            artificial preservatives, making it the ideal choice
                            for those who prefer the pure taste of peanuts.
                            Packed with protein and healthy fats, this variant
                            provides the energy you need to power through your
                            day.
                          </p>
                          <p>
                          ...
                          <p className="mb-2">
                            <b>High in Protein:</b> 28g of protein per 100g to
                            help build and repair muscle tissues. Rich in
                            Healthy Fats: A source of monounsaturated and
                            polyunsaturated fats for heart health.
                          </p>
                          <p className="mb-3">
                            <b>No Added Sugar or Preservatives:</b> Perfect for
                            those seeking a clean, natural snack. Rich in
                            Essential Nutrients: Includes vitamins and minerals
                            such as Vitamin E, magnesium, and potassium.
                          </p>
                          <p>
                            <strong>Directions of Use:</strong>
                          </p>
                          <p className="mb-2">
                            Spread on toast, crackers, or sandwiches for a
                            nutritious snack.
                          </p>
                          <p className="mb-2">
                            Use as a topping for fruit, oatmeal, or yogurt for
                            an extra protein boost.
                          </p>
                          <p className="mb-2">
                            Blend into smoothies for added flavor and texture.
                          </p>
                          <p className="mb-3">
                            Can be eaten straight from the jar for a quick
                            energy snack.
                          </p>
                        </div>
                      </div>
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="674b028027420607a74da22c" />
          </div>
          <CertifiedProduct />
        </section>
      </div>
...
export default GomziNutritionNaturalCrunchyPeanutButter;
