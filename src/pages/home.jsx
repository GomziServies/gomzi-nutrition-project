...
function Home() {
  ...
  const [butterProducts, setButterProducts] = useState([]);
  ...
  useEffect(() => {
    const loadInitialProducts = () => {
      ...
      const clothesProducts = gomzinutrition[0].clothes.slice(0, productsPerPage);
      ...
      setButterProducts(butterProducts);
      setShakeProducts(shakeProducts);
      setBarProducts(barProducts);
  ...
  const gomzinutrition = [
    {
      ...
      butter: [
        ...
        },
        {
          ...
          productLink: "/nutrition/gomzi-nutrition-chocolate-crunchy-peanut-butter",
        ...
        },
        {
          ...
          productLink: "/nutrition/gomzi-nutrition-mango-chia-seed-crunchy-peanut-butter",
      ...
      clothes: [
        {
          ...
          productLink:
            "/nutrition/gomzi-nutrition-sports-active-t-shirt",
        ...
        },
        {
          ...
          productLink:
            "/nutrition/gomzi-nutrition-sports-jogger",
    ...
    <>
      ...
      <div className="my-auto">
        ...
        <section className="product-tabination d-md-block d-none bg-secondaryyyy">
          <div className="container-fluid w-80">
            <div className="row">
              <div className="col-3 px-0 product-tab-sidebar product-tab-sidebar-scroll" id="style-1">
                <ul className="scrollspy">
                  ...
                  <li
                    data-id="butter"
                    className={activeSection === "#butter" ? "isCurrent" : ""}
                  >
                    <a href="#butter">
                      <div className="media">
                        <img
                          ...
                          src={
                            process.env.PUBLIC_URL +
                            "/assets/images/nutrition/sort-6.webp"
                          }
                          alt="Peanut Butter"
                        />
                        <div className="media-body align-self-center">
                  ...
                  <li
                    data-id="bar"
                    className={activeSection === "#bar" ? "isCurrent" : ""}
                  >
                    <a href="#bar">
                      <div className="media">
                        <img
                          ...
                          src={
                            process.env.PUBLIC_URL +
                            "/assets/images/nutrition/sort-7.webp"
                          }
                          alt="protein Bar"
                        />
                        <div className="media-body align-self-center">
                  ...
                  <li
                    data-id="clothes"
                    className={activeSection === "#clothes" ? "isCurrent" : ""}
                  >
                    <a href="#clothes">
                      <div className="media">
                        <img
                          ...
                          src={
                            process.env.PUBLIC_URL +
                            "/assets/images/nutrition/sort-8.webp"
                          }
                          alt="clothes"
                        />
                        <div className="media-body align-self-center">
