  ...
  const gomzinutrition = [
    {
      ...
      butter: [
        {
          ...
          productLink:
            "/nutrition/gomzi-nutrition-natural-crunchy-peanut-butter",
      ...
      energy: [
        ...
        },
        {
          ...
          productLink:
            "/nutrition/gomzi-nutrition-performance-pre-workout-drink",
      ...
      <div className="my-auto">
        ...
        <section className="product-tabination d-md-block d-none bg-secondaryyyy">
          <div className="container-fluid w-80">
            <div className="row">
              <div
                className="col-3 px-0 product-tab-sidebar product-tab-sidebar-scroll"
                id="style-1"
              >
