...
function ChatBotGomziComponent() {
  ...
  const [, setOtherMessage] = useState("");
  ...
  const getUserData = async () => {
    try {
      ...
      const rawFirst = (response.data.data.user.first_name || "").trim();
      const rawLast = (response.data.data.user.last_name || "").trim();
      setFormInputs({
        first_name: rawFirst.toLowerCase() === "fg" ? "" : rawFirst,
        last_name: rawLast.toLowerCase() === "user" ? "" : rawLast,
  ...
  const startBot = () => {
    ...
    setTimeout(() => {
      setBotMessages([{ content: "Hi, welcome to Gomzi Lifescience! 👋" }]);
    ...
    setTimeout(() => {
      setBotMessages((prevMessages) => [
        ...prevMessages,
        { content: "We are the manufacturing and branding experts." },
      ]);
      ...
      setBotMessages((prevMessages) => [
        ...prevMessages,
        {
          ...
          action: {
            ...
            options: [
              {
                text: "Technical Glitches in App or Website.",
                value: "issue6",
              },
            ],
          },
            ...
            : choice === "issue3"
              ...
              : choice === "issue4"
                ...
                : choice === "issue5"
                  ? "Shipment Status."
                  : choice === "issue6"
                    ? "Technical Glitches in App or Website."
                    : choice === "issue7"
                      ? "Payment Issues."
                      : choice === "other"
                        ? "Other..."
...
export default ChatBotGomziComponent;
